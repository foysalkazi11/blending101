  ...
  return (
    <div className={styles.privacyPolicyContainer}>
      ...
      <ul>
        ...
        <li>
          <h4>
            ...
            <span>
              ...
              Agreement) refers to Blending 101.
            </span>
          </h4>
        </li>
        <li>
        ...
        <li>
          <h4>
            Country <span> refers to: Florida, United States</span>
          </h4>
        </li>
        <li>
          <h4>
        ...
        <li>
          <h4>
            Service <span>Service refers to the Website.</span>
          </h4>
        </li>
        <li>
          <h4>
        ...
        <li>
          <h4>
            Account{" "}
            <span>
              Website refers to Blending 101, accessible from 
              <a href="https://app.blending101.com/login/" target="_blank">
                Blending101
              </a>{" "}
            </span>
             
      ...
      <p>
        ...
        transferred to â€” and maintained on â€” computers located outside of Your state, province, country or other
      ...
      <ul>
        <List description="Comply with a legal obligation" />
        <List description="Protect and defend the rights or property of the Company" />
        <List description="Prevent or investigate possible wrongdoing in connection with the Service" />
        <List description="Protect the personal safety of Users of the Service or the public" />
        <List description="Protect against legal liability" />
      </ul>
      ...
      <ul>
        <li>
          By Email :{" "}
          <a href="mailto:gabriel@blending101.com" target="_blank">
...
PrivacyPolicy.meta = {
  icon: <FontAwesomeIcon icon={faSirenOn} />,
