...
const RecipeItem = (props:RecipeItemProps) => {
	...
	const {item,plusIcon = true,dragIcon = true,deleteIcon=false,handleClick,handleDelete} = props
    ...
    return (
            ...
            { items?.label }
											...
											{plusIcon ?
											<button className={styles.listContainer__addBtn} onClick={()=>handleClick ? handleClick(items) : null} > 
